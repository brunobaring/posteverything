...
class LoginView: UIView {
    @IBOutlet weak var nameTextFieldHeightConstrain: NSLayoutConstraint!
    ...
    func swapUserActionAnimation(withDuration duration: TimeInterval) {
        ...
        UIView.animate(withDuration: duration, animations: {
            ...
            case .loginOnTop:
                ...
                self.nameTextFieldHeightConstrain.constant = height
                self.layoutIfNeeded()
            case .signupOnTop:
                self.actionButtonState = .loginOnTop
                self.nameTextFieldHeightConstrain.constant = 0
                self.layoutIfNeeded()
            }
